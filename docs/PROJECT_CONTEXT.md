...
- Development backend: AWS self-hosted Supabase is the canonical development and integration-test environment through `http://localhost:8080`; the former Supabase Cloud project is inactive and forbidden for development/testing.
